...
HD_PWD='F:/Study/Subject_L/COD_LAB/LAB1/Fibonacci/Fibonacci.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Fibonacci.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Fibonacci.tcl -notrace
