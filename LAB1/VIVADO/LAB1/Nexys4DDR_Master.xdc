...
set_property -dict { PACKAGE_PIN H6    IOSTANDARD LVCMOS33 } [get_ports { OP[0] }]; #IO_L24P_T3_35 Sch=sw[12]
set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { OP[1] }]; #IO_L20P_T3_A08_D24_14 Sch=sw[13]
set_property -dict { PACKAGE_PIN U11   IOSTANDARD LVCMOS33 } [get_ports { OP[2] }]; #IO_L19N_T3_A09_D25_VREF_14 Sch=sw[14]
