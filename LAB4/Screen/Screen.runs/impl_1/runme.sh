...
HD_PWD='F:/Study/Subject_L/COD_LAB/LAB4/Screen/Screen.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PCU.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PCU.tcl -notrace
