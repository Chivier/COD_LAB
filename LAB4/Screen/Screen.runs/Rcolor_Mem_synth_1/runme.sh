...
HD_PWD='F:/Study/Subject_L/COD_LAB/LAB4/Screen/Screen.runs/Rcolor_Mem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Rcolor_Mem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Rcolor_Mem.tcl
