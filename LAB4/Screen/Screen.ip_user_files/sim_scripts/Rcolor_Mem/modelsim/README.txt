...
#
# Generated by export_simulation on Fri Apr 12 00:48:51 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './Rcolor_Mem.sh' script.

./Rcolor_Mem.sh -reset_run
...
./Rcolor_Mem.sh -noclean_files

For more information on the script, please type './Rcolor_Mem.sh -help'.
