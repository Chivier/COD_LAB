...
HD_PWD='F:/Study/Subject_L/COD_LAB/LAB4/VGAtest/VGAtest.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hvsync_generator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hvsync_generator.tcl -notrace
