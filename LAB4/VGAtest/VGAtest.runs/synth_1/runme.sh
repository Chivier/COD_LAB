...
HD_PWD='F:/Study/Subject_L/COD_LAB/LAB4/VGAtest/VGAtest.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hvsync_generator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hvsync_generator.tcl
